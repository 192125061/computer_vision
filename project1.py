...
video_path = 'E:/computer_vision/sample.mp4'  # Replace with your video file path
...
while cap.isOpened():
    ...
    # Process the frame (resize, detect number plate, etc.)
    img2 = cv2.resize(frame, (600, 600))
